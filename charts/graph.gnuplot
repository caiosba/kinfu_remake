...
plot "yes-omp.log"  using 1:2 with lines lw 2 title sprintf('Refactored + OMP (total: %ds, average: %dms/frame)', total1, avg1), \
     "no-omp.log"   using 1:2 with lines lw 2 title sprintf('Refactored (total: %ds, average: %dms/frame)', total2, avg2), \
